...
const data = {
    dataPageHombre: {
      ...
      cardHeader: {
        ...
        titulo: 'LO MEJOR EN ROPA ADIDAS',
        ...
        }    
        {
          ...
          <figcaption className="md:absolute mt-2 md:flex md:flex-col md:h-full md:items-start md:py-8 md:justify-end xl:py-56 xl:px-20">
            ...
            <div className=" md:px-5">
              ...
              >
              <span   className="px-5 cursor-pointer py-2 text-sm bg-black text-white  md:text-black md:bg-white font-semibold font-sans xl:text-lg" >
