...
export default function PaginaNuestrasTiendas({props}) {
;
            ...
            >
              <div className="relative flex max-w-[24rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                <div className="relative m-0 overflow-hidden rounded-none bg-transparent bg-clip-border text-gray-700 shadow-none">
                                {
                        props.TiendaGrauImageCard.map(el=>(
                            <img src={el.secure_url} alt="ui/ux review check" />
                        ))  
                        }
                ...
                <div className="p-6">
                  ...
                  Fritz Sport, Av. Miguel Graú 231, Lima 15001
                  </p>
                </div>
                <div className="flex items-center justify-between p-6">
                  <div className="w-full flex justify-around">
                    ...
                    </Button>
                    {
                        ...
                        props.TiendaGrauUbicacion.map(el=>(
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="w-full flex flex-col  items-center justify-center">
                          {props.TiendaGrauHorarios.map((el, i) => (
                            <div
                              key={i}
        ...
        {/* Miguel Graú */}
            ...
            <div className="p-0 md:w-1/3 md:mb-0 mb-6 flex flex-col justify-center items-center max-w-sm mx-auto">
                <div className="relative flex max-w-[24rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                    <div className="relative m-0 overflow-hidden rounded-none bg-transparent bg-clip-border text-gray-700 shadow-none">
                                    {
                            props.TiendaTumbesImageCard.map(el=>(
                                <img src={el.secure_url} alt="ui/ux review check" />
                            ))  
                            }
                    ...
                    <div className="w-full flex justify-around">
                        ...
                        </Button>
                        {
                            ...
                            props.TiendaTumbesUbicacion.map(el=>(
                        ...
                        >
                            {' '}
                            <div className="w-full flex flex-col  items-center justify-center">
                            {props.TiendaTumbesHorarios.map((el, i) => (
                                <div
                                key={i}
                                className="my-2 w-full  border-b-2 text-center"
                                >
