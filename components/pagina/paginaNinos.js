...
const data = {
    dataPageHombre: {
      ...
      nav: [
        {
          title: 'Calzado',
          url: '/tienda?pwa_ecom_ui_template_products%5BrefinementList%5D%5BGenero%5D%5B0%5D=Niños&pwa_ecom_ui_template_products%5BrefinementList%5D%5BCategoria%5D%5B0%5D=Zapatillas',
        },
        {
          title: 'Ropa',
      ...
      cardHeader: {
        ...
        titulo: 'LO MEJOR EN ROPA PARA NIÑO',
        desc: '',
...
export default function PaginaNinos({props}) {
  ...
  if(!props.NinosPortadaDesktop || !props.NinosLoMasNuevo) return <div>Cargando..</div>
    ...
    <div>
      ...
      <main className="mx-3 md:mx-4 xl:mx-0">
        ...
        
        {
            ...
            isDesktopOrLaptop  && (
                <>
                     { props.NinosPortadaDesktop.map(el=>(
                                <img
                                    src={el.secure_url}
                                    alt=""
                                    className=""
        ...
        }    
        {
            ...
            !isDesktopOrLaptop  && (
                <>
                    { props.NinosPortadaMobil.map(el=>(
                                <img
                                    src={el.secure_url}
                                    alt=""
                                    className=""
