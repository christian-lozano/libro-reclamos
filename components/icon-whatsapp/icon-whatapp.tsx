export default function IconWhatapp() {
  return (
    <a
      ...
      target="_blank"
      className="z-header fixed  sticky-0 bottom-0 xl:right-16 right-5   "
      rel="noreferrer"
    >
      <div className=" cursor-pointer justify-end md:w-28  h-[50px] mb-[6vh]  relative  mr-1  pl-1  rounded-r-full flex items-center">
        <span className="  animate-ping absolute rounded-full xl:w-[50px] xl:h-[50px] h-[30px] w-[30px]   bg-green-600"></span>

        <svg
          className="z-20 w-[30px] h-[30px] xl:w-[50px] xl:h-[50px]  "
          viewBox="0 0 30 30"
          fill="none"
